...
func (r *Router) ApplyHook(name string, w http.ResponseWriter, req *http.Request) {
...
func (r *Router) ServeHTTP(w http.ResponseWriter, req *http.Request) {
	r.ApplyHook(HookBeforeRouter, w, req)
	defer r.ApplyHook(HookAfterRouter, w, req)
	...
	// TODO: all request executes middlewares
	r.middleware.ServeHTTP(w, req)
	exception := context.Get(req, "ctx_req_error")
	if exception == nil {
